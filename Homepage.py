...
a5.page_link('pages/0_Summary.py',label='Dashboard',icon='📊',disabled=False)
...
a5.page_link("pages/9_Reagents.py", label='Reagents', icon="⚗️",disabled = st.session_state['Reagents status'])
